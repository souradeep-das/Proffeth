...
- [Tech Stack](#tech-stack)
  ...
  The platform connects people from all over the world so that people can learn from each other.People using the platform are of usually two types- the learner and the trainer.A person can be both a traine and a learner in the same time. A learner can use the platform for buying a course at a specified cost or can request a course he wants to learn.
  #### Adding a course
  ...
  #### Requesting a course
  People can come in to the platform and request to teach them any skill they wish to learn.They can opt for quoting the fee they wish to pay for the course.People can even request for help with certain projects. The course requests are sent in with the course fee paid to the contract and are open for acquiring trainers.The course fee paid to the contract provides a security measure for the trainers that the learners can not back out afterwads. The learner has the option to revoke the request anytime, before it is accepted and gets the fee back instantly.
